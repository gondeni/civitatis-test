...
$submit = array('name' => 'submit', 'value' => 'Buscar', 'title' => 'Buscar', 'type' => 'submit', 'class' => 'btn btn-primary input-sm btn-sm buscar');
?>
<div class="contenedor">
    <div class="row">
        <div class="col-md-12">
            ...
            <hr/>
            <p>Introduzca un rango de fechas y un número de personas para obtener el listado de las actividades vigentes para el periodo.</p>
